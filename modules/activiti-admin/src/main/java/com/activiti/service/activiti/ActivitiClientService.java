...
public class ActivitiClientService {
    ...
    public CloseableHttpClient getHttpClient(ServerConfig serverConfig) {
        return getHttpClient(serverConfig.getIamURL(), serverConfig.getClientSecret(),
    ...
    public CloseableHttpClient getHttpClient(String iamUrl, String clientSecret, String userName, String password) {
        ...
        log.info("getHttpClient, iamUrl: {}, clientSecret: {}, userName: {}, password: {}", iamUrl, clientSecret, userName, password);
    ...
    public JsonNode executeRequest(HttpUriRequest request, ServerConfig serverConfig, int expectedStatusCode) {
        return executeRequest(request, serverConfig.getIamURL(), serverConfig.getClientSecret(),
     ...
     * from the client, if possible.
     */
    public JsonNode executeRequest(HttpUriRequest request, String iamUrl, String clientSecret, String userName, String password, int expectedStatusCode) {
